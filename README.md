...
- **Modo local (recomendado)**: backend e frontend rodando localmente, com banco PostgreSQL via Docker
- **Modo totalmente local**: backend, frontend e banco rodando fora do Docker
...
##⚙️ Opção 2 — Tudo local (sem Docker)

É necessário ter o PostgreSQL instalado localmente.
Crie um banco com:
Nome: ecommerce
Usuário: postgres
Senha: postgres
